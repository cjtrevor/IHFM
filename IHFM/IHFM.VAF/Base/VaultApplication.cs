...
namespace IHFM.VAF
{
    ...
    public partial class VaultApplication
        : MFiles.VAF.Extensions.ConfigurableVaultApplicationBase<Configuration>, IUsesTaskQueue
    {
                ...
                this.TaskProcessor = new SequentialTaskProcessor(
                    new AppTaskProcessorSettings
                    {
                        ...
                        QueueDef = new TaskQueueDef
                        {
                            ...
                            MaximumPollingIntervalInSeconds = 100,
                            LastBroadcastId = ""
                        },
        ...
        public string AddItemToSequentialQueue(EventHandlerEnvironment env)
        {
            // Sanity.
        ...
        protected override void StartApplication()
        {
            try
            {
                ...
                {
                    new DailyCareBackgroundOperations().GenerateProgressNotesPerResident(this, job.Vault, Configuration);
