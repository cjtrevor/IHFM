    ...
    public partial class VaultApplication
    {
        ...
        public void BeforeQRCode_CheckinChangesFinalize(EventHandlerEnvironment env)
        {
            try
            {
                ...
                var roomNumber = env.ObjVerEx.GetPropertyText(Configuration.QRCode_RoomNumber_Text);
                var resRoom = env.ObjVerEx.GetLookupID(Configuration.QRCode_ResRoom_SelfMade);
                ...
                Dictionary<int, string> properties = new Dictionary<int, string>
                {
                    ...
                    //{ Configuration.QRCode_RoomNumber_Text.ID, roomNumber },
                    { Configuration.QRCode_ResRoom_SelfMade.ID, resRoom.ToString() },
